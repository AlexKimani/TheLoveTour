...
<section id="slide-show">
	<div id="slider" class="sl-slider-wrapper">
		...
		<div class="sl-slider">
			<!--Slider Item1-->
			<div class="sl-slide item1" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25"
		...
		<div class="row-fluid">
			<div class="span4">
				<div class="media">
					...
					<div class="media-body">
						<h4 class="media-heading">Vission</h4>
			...
			<div class="span4">
				<div class="media">
					...
					<div class="media-body">
						<h4 class="media-heading">Goals</h4>
							...
							<div class="row-fluid">
								<ul class="thumbnails">
									<li class="span3"><a href="#"><img
													src="<?php echo base_url(); ?>images/sample/clients/client1
													.png"></a></li>
									<li class="span3"><a href="#"><img
													src="<?php echo base_url(); ?>images/sample/clients/client2
													.png"></a></li>
									<li class="span3"><a href="#"><img
													src="<?php echo base_url(); ?>images/sample/clients/client3
													.png"></a></li>
									<li class="span3"><a href="#"><img
													src="<?php echo base_url(); ?>images/sample/clients/client4
													.png"></a></li>
								</ul>
							</div>
						</div>
